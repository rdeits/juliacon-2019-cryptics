...
* For these slides, go to:
    * [rdeits.github.com/juliacon-2019-cryptics](http://rdeits.github.com/juliacon-2019-cryptics)
* To see the demo (if you all haven't crashed it yet), check out:
    * <http://cryptics.robindeits.com>
* To try it on NextJournal, check out:
    * <https://nextjournal.com/a/LS8EN7R9uUV58X6YUFMEw?token=UHdzXXGea7EdgpsuvYvydY>
